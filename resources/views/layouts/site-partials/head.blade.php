<head>
    ...
    <script type="text/javascript" src="/site-assets/js/jquery.mousewheel.js"></script>
    <script type="text/javascript" src="/site-assets/js/jquery.jscrollpane.min.js"></script>
